...
int main(int argc, char** argv)
{
    ...
    ros::Subscriber gridmap_sub_ = nh.subscribe<quadrotor_msgs::OccMap3d>("gridmap_inflate", 1, &gridmap_callback, ros::TransportHints().tcpNoDelay());
    ros::Subscriber triger_sub_  = nh.subscribe<geometry_msgs::PoseStamped>("triger", 10, &triger_callback, ros::TransportHints().tcpNoDelay());
